...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        lista.add(aEstudios.get(0));
        lista.add(aEstudios.get(1));
        Pelicula avatar = new Pelicula("Avatar",2003,120,"Fantasia",lista);
        Pelicula spiderman = new Pelicula("Spiderman",2021,140,"Accion",lista);
        Pelicula waydown = new Pelicula("Way Down",2020,150,"Terror",lista);
    ...
    public static void funcionPeliculaLarga () {
        ...
        javax.swing.JOptionPane.showMessageDialog(null,"La pelicula mas larga es " + larga.getTitulo());
    }
